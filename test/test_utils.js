...
describe(`${pkg.name}:utils`, () => {
    ...
    describe('utils:#loadFilesFromDir', () => {
        ...
        it('should return an empty array if no files were found.', async () => {
        ...
        it('should fail if an invalid cwd option is passed.', async () => {
        ...
        it('should fail if cwd is not a directory.', async () => {
            ...
            try {
                await utils.loadFilesFromDir('*.js', { cwd: `${__dirname}/artifacts/routes/routes_a.js` });
            }
            catch (e) {
                error = e;
            }
